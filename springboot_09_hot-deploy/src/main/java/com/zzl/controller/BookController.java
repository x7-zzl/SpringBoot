...
public class BookController {
    ...
    public R getPage(@PathVariable int currentPage, @PathVariable int pageSize,Book book) {
        System.out.println("test hot deploy11111111111111111111111");
        System.out.println("test hot deploy222222222222222");
        System.out.println("test hot deploy3");
        System.out.println("test hot deploy4");
        System.out.println("test hot deploy5");
